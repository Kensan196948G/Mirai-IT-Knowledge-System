...
class EnvironmentConfig:
    ...
    def _load_environment(self):
        ...
        self.config = {
            ...
            "database_backup_path": self.get_path_env(
                "DATABASE_BACKUP_PATH", "backups/dev"
            ),
            # ログ設定
            ...
            # SubAgent設定
            "subagent_architect_enabled": self.get_bool_env(
                "SUBAGENT_ARCHITECT_ENABLED", True
            ),
            "subagent_knowledge_curator_enabled": self.get_bool_env(
                "SUBAGENT_KNOWLEDGE_CURATOR_ENABLED", True
            ),
            "subagent_itsm_expert_enabled": self.get_bool_env(
                "SUBAGENT_ITSM_EXPERT_ENABLED", True
            ),
            "subagent_devops_enabled": self.get_bool_env(
                "SUBAGENT_DEVOPS_ENABLED", True
            ),
            "subagent_qa_enabled": self.get_bool_env("SUBAGENT_QA_ENABLED", True),
            "subagent_coordinator_enabled": self.get_bool_env(
                "SUBAGENT_COORDINATOR_ENABLED", True
            ),
            "subagent_documenter_enabled": self.get_bool_env(
                "SUBAGENT_DOCUMENTER_ENABLED", True
            ),
            # Hooks設定
            ...
            "hook_duplicate_check_enabled": self.get_bool_env(
                "HOOK_DUPLICATE_CHECK_ENABLED", True
            ),
            "hook_deviation_check_enabled": self.get_bool_env(
                "HOOK_DEVIATION_CHECK_ENABLED", True
            ),
            "hook_auto_summary_enabled": self.get_bool_env(
                "HOOK_AUTO_SUMMARY_ENABLED", True
            ),
            # MCP統合設定
            ...
            "mcp_brave_search_enabled": self.get_bool_env(
